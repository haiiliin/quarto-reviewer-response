...
{
   \begin{tcolorbox}[colback=gray!10, colframe=black, width=\linewidth, arc=1.2mm, auto outer arc, boxrule=0.3pt, breakable]
...
{
   \begin{tcolorbox}[colback=green!20, colframe=black, width=\linewidth, arc=1.2mm, auto outer arc, boxrule=0.3pt, breakable]
   \textcolor{red}{\textbf{Change}} #1
   \tcblower
}{
   \end{tcolorbox}
}
...
{
   \begin{tcolorbox}[colback=yellow!20, colframe=black, width=\linewidth, arc=1.2mm, auto outer arc, boxrule=0.3pt, breakable]
